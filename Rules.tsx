  ...
  return (
    <div className="flex flex-col section  container">
      <div className="w-full mx-auto text-2xl px-4">
        ...
        New-Age E-Waste Rules in India
        </h2>
        <p className="mb-2"></p>
        <p className="mb-2">
        ...
        <h3 className="text-3xl font-bold mb-2 text-blue-800">CHAPTER I</h3>
        <p className="mb-2">
        ...
        <h3 className="text-3xl font-bold mb-2 text-blue-800">CHAPTER II</h3>
        <p className="mb-2">
      ...
      <div className="flex flex-col md:flex-row w-full mx-auto md:w-full md:max-h-140 max-h-[130rem] gap-10 md:mt-24 px-4">
        <div className="flex flex-col w-full my-4 projects shadow-lg bg-gray-400 border border-gray-500 overflow-y-auto p-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 py-4 shadow-sm text-center text-blue-800">
            Notification
          </h2>
